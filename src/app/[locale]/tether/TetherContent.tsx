...
import { TETHER_VIDEO } from "@/lib/constants";

export default function TetherContent() {
  const t = useTranslations("tether_page");
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          >
            <div className="overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.02]">
              <div className="aspect-video">
                <iframe
                  src={`https://www.youtube.com/embed/${TETHER_VIDEO.videoId}?autoplay=1&mute=1&loop=1&playlist=${TETHER_VIDEO.videoId}&rel=0&modestbranding=1`}
          ...
          <motion.div
            ...
            className="mt-16 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 md:p-8"
          >
