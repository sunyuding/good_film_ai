...
import { TRAE_VIDEOS } from "@/lib/constants";

const videoKeys = ["launch", "vision", "community"] as const;

export default function TraeContent() {
  const t = useTranslations("trae_page");
                ...
                >
                  <div className="overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.02]">
                    <div className="aspect-video">
                      <iframe
                        src={`https://www.youtube.com/embed/${video.videoId}?autoplay=1&mute=1&loop=1&playlist=${video.videoId}&rel=0&modestbranding=1`}
